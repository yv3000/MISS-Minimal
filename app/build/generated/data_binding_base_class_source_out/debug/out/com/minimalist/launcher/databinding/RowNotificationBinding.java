...
public final class RowNotificationBinding implements ViewBinding {
  ...
  private RowNotificationBinding(@NonNull ConstraintLayout rootView, @NonNull TextView tvAppName,
      @NonNull TextView tvTimeCount) {
  ...
  public static RowNotificationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RowNotificationBinding((ConstraintLayout) rootView, tvAppName, tvTimeCount);
    }
